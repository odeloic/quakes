...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TextCarousel = __webpack_require__(5);
...
/***/ (function(module, exports) {
	...
	var Menu = function () {
	  function Menu() {
	    ...
	    this.menuNavigation = document.querySelector(".navigation");
	    this.events();
	  }
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function events() {
	      this.menuIcon.addEventListener("click", this.openMenu.bind(this));
	      this.menuIcon.addEventListener('mouseover', this.openMenu.bind(this));
	      this.menuNavigation.addEventListener("mouseleave", this.closeMenu.bind(this));
	    }
	  }, {
	    key: "openMenu",
	    value: function openMenu() {
	      this.menuIcon.classList.toggle("menu-is-open");
	      this.menuNavigation.classList.toggle("menu-is-open");
	    }
	  }, {
	    key: "closeMenu",
	    value: function closeMenu() {
	      this.menuIcon.classList.remove("menu-is-open");
	      this.menuNavigation.classList.remove("menu-is-open");
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	var TextCarousel = function () {
	  function TextCarousel() {
	    ...
	    // this.index;
	    this.slidesIndex = 0;
	    this.slides = document.querySelectorAll(".sliding-texts h2");
	    this.slidesLength = this.slides.length;
	    this.changeTexts();
	  }

	  _createClass(TextCarousel, [{
	    key: "changeTexts",
	    value: function changeTexts() {
